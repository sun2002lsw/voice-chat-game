...
def test_load_scenario_parses_visit_overflow(scenarios_root):
    graph = {
        "scenario": "hello",
        "steps": [
            {
                ...
                "next_steps": ["2. ask", "1. greet"],
                "visit_overflow": {"after": 3, "next_step": "2. ask"},
            },
            {
                "step": "2. ask",
                "scene": "...",
    ...
    _write_scenario(
        ...
        graph=graph,
        steps_setup=[
            {"name": "1. greet", "script_count": 3},
            {"name": "2. ask"},
        ],
    )

    sc = load_scenario("hello")
    overflow = sc._steps_by_name["1. greet"].visit_overflow

    assert overflow is not None
    assert overflow.after == 3
    assert overflow.next_step == "2. ask"


def test_load_scenario_raises_when_overflow_next_step_unknown(scenarios_root):
    graph = {
        "scenario": "hello",
        "steps": [
            {
                ...
                "complete_conditions": ["a", "b"],
                "next_steps": ["2. ask", "1. greet"],
                "visit_overflow": {"after": 1, "next_step": "ghost"},
            },
            {
                "step": "2. ask",
                "scene": "...",
    ...
    _write_scenario(
        ...
        name="hello",
        graph=graph,
        steps_setup=[{"name": "1. greet"}, {"name": "2. ask"}],
    )

    with pytest.raises(ValueError, match="존재하지 않는 step 'ghost'"):
        load_scenario("hello")


def test_load_scenario_raises_when_overflow_next_step_is_self(scenarios_root):
    graph = {
        "scenario": "hello",
        "steps": [
            {
                ...
                "complete_conditions": ["a", "b"],
                "next_steps": ["2. ask", "1. greet"],
                "visit_overflow": {"after": 1, "next_step": "1. greet"},
            },
            {
                "step": "2. ask",
                "scene": "...",
...
def test_load_scenario_raises_when_overflow_after_exceeds_script_count(scenarios_root):
    graph = {
        "scenario": "hello",
        "steps": [
            {
                ...
                "complete_conditions": ["a", "b"],
                "next_steps": ["2. ask", "1. greet"],
                "visit_overflow": {"after": 5, "next_step": "2. ask"},
            },
            {
                "step": "2. ask",
                "scene": "...",
    ...
    _write_scenario(
        ...
        graph=graph,
        steps_setup=[
            {"name": "1. greet", "script_count": 2},
            {"name": "2. ask"},
        ],
    )

    with pytest.raises(ValueError, match="script 파일 개수"):
        load_scenario("hello")


def test_load_scenario_raises_when_overflow_after_not_int(scenarios_root):
    graph = {
        "scenario": "hello",
        "steps": [
            {
                ...
                "complete_conditions": ["a", "b"],
                "next_steps": ["2. ask", "1. greet"],
                "visit_overflow": {"after": "three", "next_step": "2. ask"},
            },
            {
                "step": "2. ask",
                "scene": "...",
...
def test_load_scenario_raises_when_overflow_missing_after(scenarios_root):
    graph = {
        "scenario": "hello",
        "steps": [
            {
                ...
                "complete_conditions": ["a", "b"],
                "next_steps": ["2. ask", "1. greet"],
                "visit_overflow": {"next_step": "2. ask"},
            },
            {
                "step": "2. ask",
                "scene": "...",
    ...
    with pytest.raises(ValueError, match="'after' 키가 없습니다"):
        load_scenario("hello")
